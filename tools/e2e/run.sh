...
case "$CASE_NAME" in
  cli-command-matrix | openclaw-bailian | openclaw-bailian-no-pep | openclaw-a2a | a2a-data-collab | openclaw-vllm | cmaas | hermes-agent | claude-code | codex | trustee-duo) ;;
  *) usage; exit 2 ;;
esac
